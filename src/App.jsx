        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                name: 'Republic Guru', 
                desc: 'An Ecommerse UI for digital gift cards', 
                link: 'https://republic-omega.vercel.app/', 
                gradient: 'from-blue-500 via-blue-600 to-cyan-500',
                icon: '💬'
              },
              { 
                name: 'Medisearch', 
                desc: 'A medical assistant that provides quick answers and suggestions from a curated medical database. Users can enter disease names like headache, asthma, or cancer.', 
...
export default App;
>>>>>>> 6e496f4f203f2382944ac644fbeaae2c7eef8cc4
